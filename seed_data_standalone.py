...
def seed_users():
    ...
    for i in range(NUM_USERS):
        ...
        # Use underscore instead of dot for Firebase compatibility
...
def seed_organizations(users):
    ...
    for i, org_name in enumerate(org_names[:NUM_ORGANIZATIONS]):
        ...
        print(f"  Created organization: {org_name} ({len(org_members)} members)")
...
def seed_chat_messages(users, organizations):
    ...
    for org_id in organizations:
        ...
        print(f"  Created {NUM_MESSAGES_PER_COMMUNITY} messages for {org_id}")
...
def seed_opportunities(users, organizations):
    ...
    for org_id in organizations:
        ...
        print(f"  Created {num_opps} opportunities for {org_id}")
...
def seed_analytics(users, organizations):
    ...
    for org_id in organizations:
        ...
        print(f"  Created {num_events} analytics events for {org_id}")
...
def seed_knowledge_base(organizations):
    ...
    for org_id in organizations:
        ...
        print(f"  Created {num_entries} KB entries for {org_id}")
...
def seed_all_data():
    ...
    try:
        ...
        print(f"  - Opportunities: ~{len(organizations) * 4}")
        print(f"  - Analytics Events: ~{len(organizations) * 350}")
        ...
        sample_users = list(all_users.keys())[:5]
